...
export function AuditExplorerPage() {
  ...
  return (
    <div className="ods-page ods-flow-lg">
      ...
      <div className="ods-toolbar ods-sticky-toolbar w-fit">
      ...
      <StickyTableShell scrollOffset="17rem">
        <table className="w-full text-sm">
          ...
          <tbody>
            {filtered.length === 0 ? (
              <tr><td colSpan={6} className="px-4 py-12 text-center text-sm text-muted-foreground">No audit entries yet. Audit records are written as users and the system perform actions.</td></tr>
            ) : filtered.map(log => (
